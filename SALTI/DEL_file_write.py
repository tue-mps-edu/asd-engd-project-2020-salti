...
def train(path_img_train, path_lbl_train):
    ...
    filee1 = open(r'D:\Local_PDEng_ASD\Block-02\In_House_Project\Git_version\my_current_fetch\asd-pdeng-project-2020-developer\SALTI\Train\Custom_files\training_img_paths.txt', 'w')
    given_img_dir = path_img_train
    [filee1.write(os.path.join(given_img_dir, i) + '\n') for i in os.listdir(given_img_dir)]

    # Create and save file paths for all labels in to a text file
    filee2 = open(r'D:\Local_PDEng_ASD\Block-02\In_House_Project\Git_version\my_current_fetch\asd-pdeng-project-2020-developer\SALTI\Train\Custom_files\training_lbl_paths.txt', 'w')
    given_lbl_dir = path_lbl_train
    [filee2.write(os.path.join(given_lbl_dir, i) + '\n') for i in os.listdir(given_lbl_dir)]
    ...
    if not opt.evolve:  # Train normally
        ...
        prebias()  # optional
        train(path_img_train, path_lbl_train)  # train normally
        ...
        for _ in range(1):  # generations to evolve
            ...
            # Train mutation
            prebias()
            results = train(path_img_train, path_lbl_train)
